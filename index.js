...
bot.on("guildMemberAdd", function(member) {
  ...
  .setTimestamp()
  .setFooter("Aot Version 0.40.1, Made by cleverActon0126#3517")
...
bot.on("message", async function(message) {
  ...
  switch (args[0].toLowerCase()) {
    ...
    case "update":
     ...
     .setDescription("Successfully updated to Version 0.40.1!")
     .addField("Prefix", "?a \(Uncustomable\)")
     .addField("Public Commands", "`help` \(Will lead you to other help commands\), `hello`, `aot`, `bye`, `noticeme`, `support`, `salmon`, `apple`, `pie`, `candy`, `spam`, `8ball`, `ding`, `ping`, `beep`, `door`, `coinflip`, `kill`, `roast`, `hack`, `shutdown`, `joke`,  `report`, `bugreport`, `join`, `leave`, `time`, `botinfo`, `userinfo`, `serverinfo`")
     ...
     .addField("Removed Commands", "`join`, `leave`", true)
     .addField("Updates", "Minor update 1")
     .setColor(0x00ff00)
     .setTimestamp()
     .setFooter("Aot Version 0.40.1, Made by cleverActon0126#3517")
