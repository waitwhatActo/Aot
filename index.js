...
bot.on("message", async function(message) {
  ...
  switch (args[0].toLowerCase()) {
    ...
    case "update":
     ...
     var embed = new Discord.MessageEmbed()
     .setTitle("SSR Cooperated Update")
     .setDescription("Successfully updated to Version 0.54.0!")
     ...
     .addField("Admin Commands", "`kick`, `ban`, `tempban`, `unban`, `mute`, `tempmute`, `unmute`, `clear`, `addrole`, `removerole`, `lockdown`", true)
     .addField("New Commands", "N/A", true)
     .addField("Removed Commands", "`tempaddrole`, `tempremoverole`, `unlock`", true)
     .addField("Updates", "Loads of updates: \r1. Updated content of all commands \r2. Improved lockdown command. \rFor more information, please look at the photo below to see the changes")
