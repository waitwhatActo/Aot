...
bot.on('message', async function(message) {
  ...
  switch (args[0].toLowerCase()) {
    ...
    case 'update':
     ...
     .addField('Public Commands', '`help` \(Will lead you to other help commands\), `hello`, `aot`, `bye`, `noticeme`, `support`, `salmon`, `apple`, `pie`, `candy`, `spam`, `8ball`, `ding`, `ping`, `beep`, `door`, `coinflip`, `kill`, `report`, `botinfo`, `userinfo`, `shutdown`, `hack`, `friend`, `roast`')
     ...
     .addField('Updates', 'Minor updates')
     .setColor(0x00ff00)
     .setTimestamp()
     .setFooter('Aot Version 0.33.1, Made by cleverActon0126#3517')
